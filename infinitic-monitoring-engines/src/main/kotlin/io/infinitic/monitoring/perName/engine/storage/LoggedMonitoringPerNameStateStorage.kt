 ...
 */
class LoggedMonitoringPerNameStateStorage(
    val storage: MonitoringPerNameStateStorage
) : MonitoringPerNameStateStorage by storage {

    val logger: Logger
        get() = LoggerFactory.getLogger(javaClass)

    override suspend fun getState(taskName: TaskName): MonitoringPerNameState? {
        val taskState = storage.getState(taskName)
