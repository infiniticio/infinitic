...
class JavaInfiniticClientTests {

    @Test
    public void canCreateClientThroughBuilders() {
        assertDoesNotThrow(() -> {
            TransportConfig transport = PulsarTransportConfig.builder()
            ...
            try (InfiniticClient client = InfiniticClient.builder()
