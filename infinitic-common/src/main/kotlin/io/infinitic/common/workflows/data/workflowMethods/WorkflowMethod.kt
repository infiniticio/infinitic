...
data class WorkflowMethod(
  ...
  @Deprecated("Not used anymore after 0.13.0") @AvroDefault(Avro.NULL) val parentWorkflowMethodName: MethodName? = null,
  @Deprecated("Not used anymore after 0.13.0") @AvroName("parentMethodRunId") @SerialName("parentMethodRunId") val parentWorkflowMethodId: WorkflowMethodId? = null,
  @Deprecated("Not used anymore after 0.13.0") @AvroDefault(Avro.NULL) val parentClientName: ClientName? = null,
