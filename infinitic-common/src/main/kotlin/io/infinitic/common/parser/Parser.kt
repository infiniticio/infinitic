...
private fun getMethodPerAnnotationAndParameterTypes(
    klass: Class<*>,
    name: String,
    parameterTypes: List<String>
): Method? {
  ...
  do {
    ...
    clazz.interfaces.forEach { interfaze ->
      getMethodPerAnnotationAndParameterTypes(interfaze, name, parameterTypes)?.also {
        return it
      }
    }
...
private fun getMethodPerNameAndParameterTypes(
    klass: Class<*>,
    name: String,
    parameterTypes: List<String>
): Method? =
...
private fun getMethodPerAnnotationAndParametersCount(
    klass: Class<*>,
    name: String,
    parameterCount: Int
): Method? {
  ...
  do {
    ...
    clazz.interfaces.forEach { interfaze ->
      getMethodPerAnnotationAndParametersCount(interfaze, name, parameterCount)?.also {
        return it
      }
    }
...
private fun getMethodPerNameAndParameterCount(
    klass: Class<*>,
    name: String,
    parameterCount: Int
): Method? {
