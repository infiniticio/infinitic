...
package io.infinitic.common.tasks.metrics.storage
 ...
 */
interface TaskMetricsStateStorage : Flushable {

    suspend fun getState(name: Name): TaskMetricsState?

    suspend fun putState(name: Name, state: TaskMetricsState)
