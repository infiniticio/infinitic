...
object MissingMetaJavaClassException :
...
class WrongSerializationTypeException(name: String?, type: SerializedDataType) :
    SerializationException(
        msg =
            "Trying to retrieve json from \"$name\" serialized data, but the serialized format is $type",
        help = "")

class SerializerNotFoundException(name: String) :
    SerializationException(
...
class KotlinDeserializationException(name: String, causeString: String) :
    SerializationException(
        msg =
...
class JsonDeserializationException(name: String, causeString: String) :
    SerializationException(
        msg =
