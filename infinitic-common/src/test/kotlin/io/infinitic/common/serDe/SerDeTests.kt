...
@Serializable private sealed class Obj
...
@Serializable private data class Obj2(val foo: String, val bar: Int) : Obj()

@Serializable private data class Objs(val objs: Set<Obj>)
