...
@Suppress("unused")
class RegisteredWorkflowTests : StringSpec({
    ...
    "Get instance with single class" {
        val rw = RegisteredWorkflow(
            WorkflowName("foo"),
            listOf(MyWorkflow::class.java),
            42,
            null,
            null,
            null
        ...
        // get unknown version
        val e = shouldThrow<UnknownWorkflowVersionException> { rw.getInstance(WorkflowVersion(1)) }
    ...
    "Get instance with single class with version" {
        val rw = RegisteredWorkflow(
            WorkflowName("foo"),
            listOf(MyWorkflow_2::class.java),
            42,
            null,
            null,
            null
