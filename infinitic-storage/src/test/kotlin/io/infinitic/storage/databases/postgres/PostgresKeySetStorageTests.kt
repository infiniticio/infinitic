...
import io.infinitic.storage.keySet.KeySetStorageTests
import io.kotest.core.annotation.EnabledIf

@EnabledIf(DockerOnly::class)
internal class PostgresKeySetStorageTests : KeySetStorageTests() {
  private val server by lazy { Postgres.createServer() }
  private val config by lazy { Postgres.getConfig(server) }

  override fun createStorage() = PostgresKeySetStorage.from(config)
