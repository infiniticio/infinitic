...
import com.zenaton.workflowManager.avroEngines.Samples.WorkflowA
...
//                sendJobCompleted(avro, AvroConverter.toAvroDecisionOutput(out))
    ...
    fun runDecision(workflow: Any, branches: List<Branch>, properties: PropertyStore): DecisionOutput? {
        return null
    }
