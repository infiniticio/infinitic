...
suspend fun <T> Consumer<T>.acknowledgeSuspend(messageId: MessageId): Unit = suspendCancellableCoroutine { cont ->
    val future = acknowledgeAsync(messageId)
...
suspend fun <T> Consumer<T>.acknowledgeSuspend(message: Message<T>): Unit = suspendCancellableCoroutine { cont ->
    val future = acknowledgeAsync(message)
