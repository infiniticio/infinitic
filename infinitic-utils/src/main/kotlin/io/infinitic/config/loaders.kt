 ...
 */
inline fun <reified T : Any> loadFromYamlResource(vararg resources: String): T {
 ...
 */
inline fun <reified T : Any> loadFromYamlFile(vararg files: String): T {
  val builder = ConfigLoaderBuilder.default()
 ...
 */
inline fun <reified T : Any> loadFromYamlString(vararg yamls: String): T {
  val builder = ConfigLoaderBuilder.default()
