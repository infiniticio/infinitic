...
class InMemoryInfiniticClient(workerRegister: WorkerRegister) : InfiniticClientAbstract() {

  private val worker by lazy {
    InMemoryInfiniticWorker(workerRegister).apply { client = this@InMemoryInfiniticClient }
  }
  ...
  init {
    ...
    with(clientStarter) { listeningScope.startClientResponse(this@InMemoryInfiniticClient) }
