        ...
        Message::class.sealedSubclasses.forEach {
            shouldNotThrowAny {
                ...
                if (msg is ForMonitoringPerInstanceMessage) {
                    val avroMsg = AvroConverter.toAvroForMonitoringPerInstanceMessage(msg)
                    val msg2 = AvroConverter.fromAvroForMonitoringPerInstanceMessage(avroMsg)
                    val avroMsg2 = AvroConverter.toAvroForMonitoringPerInstanceMessage(msg2)
                    msg shouldBe msg2
                    avroMsg shouldBe avroMsg2
                }
