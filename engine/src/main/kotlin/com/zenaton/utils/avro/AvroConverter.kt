...
object AvroConverter {
    ...
    fun toAvro(obj: TaskState) =
        convert(obj, AvroTaskState::class)
    fun fromAvro(obj: AvroTaskState) =
        convert(obj, TaskState::class)
     ...
     *  Tasks Messages
     */
    fun toAvro(obj: TaskAttemptCompleted) =
        convert(obj, AvroTaskAttemptCompleted::class)
    fun fromAvro(obj: AvroTaskAttemptCompleted) =
        convert(obj, TaskAttemptCompleted::class)

    fun toAvro(obj: TaskAttemptFailed) =
        convert(obj, AvroTaskAttemptFailed::class)
    fun fromAvro(obj: AvroTaskAttemptFailed) =
        convert(obj, TaskAttemptFailed::class)

    fun toAvro(obj: TaskAttemptRetried) =
        convert(obj, AvroTaskAttemptRetried::class)
    fun fromAvro(obj: AvroTaskAttemptRetried) =
        convert(obj, TaskAttemptRetried::class)

    fun toAvro(obj: TaskAttemptStarted) =
        convert(obj, AvroTaskAttemptStarted::class)
    fun fromAvro(obj: AvroTaskAttemptStarted) =
        convert(obj, TaskAttemptStarted::class)

    fun toAvro(obj: TaskAttemptTimeout) =
        convert(obj, AvroTaskAttemptTimeout::class)
    fun fromAvro(obj: AvroTaskAttemptTimeout) =
        convert(obj, TaskAttemptTimeout::class)

    fun toAvro(obj: TaskDispatched) =
        convert(obj, AvroTaskDispatched::class)
    fun fromAvro(obj: AvroTaskDispatched) =
        convert(obj, TaskDispatched::class)
