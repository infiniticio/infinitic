...
import io.infinitic.events.WorkflowMethodTaskDispatched
import io.infinitic.events.WorkflowTaskDispatched

fun ServiceExecutorMessage.workflowType(): InfiniticWorkflowEventType = when (this) {
  is ExecuteTask -> when (this.isWorkflowTask()) {
    true -> WorkflowTaskDispatched
    false -> WorkflowMethodTaskDispatched
  }
}
