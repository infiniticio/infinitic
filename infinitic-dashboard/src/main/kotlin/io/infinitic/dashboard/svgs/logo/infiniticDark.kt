...
fun ElementCreator<Element>.infiniticDark(): Element {
  val svg = svg()
  svg.set("viewBox", "0 -58.28205547675359 3159.8958997990494 898.1735090176298")
      .set("width", "3159.8958997990494")
      .set("height", "898.1735090176298")
      .new {
        g().set("transform", "scale(7.9947949899524815) translate(10, 10)").new {
          g().set(
                  "transform",
