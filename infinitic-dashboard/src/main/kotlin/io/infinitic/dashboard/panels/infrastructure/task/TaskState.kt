...
data class TaskState(
    ...
    override val topicsStats: TopicsStats<ServiceTopics> = ServiceTopics.values().associateWith { Loading() },
    ...
    override fun getTopic(type: ServiceTopics) = topicName.topic(type, ServiceName(name))
}
