...
data class WorkflowState(
  ...
  override val topicsStats: TopicsStats<WorkflowTopic<*>> =
      WorkflowTopic.entries.associateWith { Loading() },
  ...
  override fun getTopic(topic: WorkflowTopic<*>) = with(resourceManager) { topic.fullName(name) }
}
