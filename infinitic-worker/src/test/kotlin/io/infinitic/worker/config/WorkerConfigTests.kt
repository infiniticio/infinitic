...
import io.infinitic.worker.samples.WorkflowA
...
class WorkerConfigTests : StringSpec({
    ...
    "task Unknown" {
        ...
        e.message!! shouldContain "class \"io.infinitic.worker.samples.UnknownTask\" is unknown"
    }
    ...
    "workflow Unknown" {
        ...
        e.message!! shouldContain "class \"io.infinitic.worker.samples.UnknownWorkflow\" is unknown"
    }
    ...
    "not a task" {
        ...
        e.message!! shouldContain "class \"io.infinitic.worker.samples.NotATask\" must extend io.infinitic.tasks.Task"
    }
    ...
    "not a workflow" {
        ...
        e.message!! shouldContain "class \"io.infinitic.worker.samples.NotAWorkflow\" must extend io.infinitic.workflows.Workflow"
    }
})
