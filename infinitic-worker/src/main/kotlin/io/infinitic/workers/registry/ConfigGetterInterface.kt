...
interface ConfigGetterInterface {
  ...
  fun getWorkflowExecutorConfig(name: String): WorkflowExecutorConfig?

  fun getWorkflowTagEngineConfig(name: String): WorkflowTagEngineConfig?

  fun getWorkflowStateEngineConfig(name: String): WorkflowStateEngineConfig?
}
