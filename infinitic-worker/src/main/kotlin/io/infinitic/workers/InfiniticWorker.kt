...
class InfiniticWorker private constructor(
    private val worker: WorkerAbstract
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun fromConfigResource(vararg resources: String) = fromConfig(WorkerConfig.fromResource(*resources))
        ...
        fun fromConfig(workerConfig: WorkerConfig): InfiniticWorker {
            ...
            return InfiniticWorker(
                when (workerConfig.transport) {
                    ...
                    Transport.inMemory ->
                        InMemoryInfiniticWorker(register)
                }
            )
        }
