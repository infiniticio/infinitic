...
package io.infinitic.worker.taskEngineWorker
...
class TaskEngineWorker(
    ...
    val sendToWorkers: SendToWorkers
) {
    data class Builder(
        var taskStateStorage: TaskStateStorage? = null,
        var sendToTaskEngine: SendToTaskEngine? = null,
        var sendToMonitoringPerName: SendToMonitoringPerName? = null,
        var sendToWorkers: SendToWorkers? = null
    ) {
        fun transport() {
        }
