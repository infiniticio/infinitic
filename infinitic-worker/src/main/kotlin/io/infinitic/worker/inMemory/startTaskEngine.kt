...
import io.infinitic.worker.DispatchTask
import io.infinitic.worker.RunTask
...
private fun CoroutineScope.startTaskEngine(
    ...
    val sendToWorkers: SendToWorkers = { msg: TaskExecutorMessage -> workerChannel.send(msg) }
