...
internal class DeferredWorkflowTests : StringSpec({
    ...
    "Sequential Workflow with an async task" {
        deferredWorkflow.seq2() shouldBe "23ba"
    }

    "Workflow waiting 2 deferred in wrong order" {
        deferredWorkflow.seq5() shouldBe 600
    }
    ...
    "Or step with 3 async tasks" {
        deferredWorkflow.or1() shouldBeIn listOf("ba", "dc", "fe")
    }
    ...
    "Or step with Status checking" {
        deferredWorkflow.or4() shouldBe "baba"
    }

    "And step with 3 async tasks" {
        deferredWorkflow.and1() shouldBe listOf("ba", "dc", "fe")
    }
