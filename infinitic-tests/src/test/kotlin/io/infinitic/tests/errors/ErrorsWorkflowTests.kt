...
internal class ErrorsWorkflowTests :
    StringSpec({
      ...
      "try/catch a failing task" { errorsWorkflow.failing1() shouldBe "ko" }
      ...
      "failing async task on main path should not throw" { errorsWorkflow.failing2a() shouldBe 100 }

      "failing task not on main path should not throw" { errorsWorkflow.failing3() shouldBe 100 }
